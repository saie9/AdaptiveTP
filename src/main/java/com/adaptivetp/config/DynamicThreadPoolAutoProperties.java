...
public class DynamicThreadPoolAutoProperties {
    ...
    /** 自适应调参配置 */
    private AutoTuneProperties autoTune = new AutoTuneProperties();

    public AutoTuneProperties getAutoTune() { return autoTune; }
    public void setAutoTune(AutoTuneProperties autoTune) { this.autoTune = autoTune; }
